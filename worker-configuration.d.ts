/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 50cf3d0f1afb5335336b5ccb9b6da773)
// Runtime types generated with workerd@1.20260219.0 2025-03-10 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "CairnMCP" | "WorkspaceIndex";
	}
	interface Env {
		...
		ADMIN_EMAIL: string;
		BASE_URL: string;
		MCP_OBJECT: DurableObjectNamespace<import("./src/index").CairnMCP>;
		WORKSPACE_INDEX: DurableObjectNamespace<import("./src/index").WorkspaceIndex>;
	}
}
